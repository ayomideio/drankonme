...
class AddDrinks extends StatefulWidget {
  final String club;
  const AddDrinks({super.key, required this.club});

  @override
  State<AddDrinks> createState() => _AddDrinksState();
}

class _AddDrinksState extends State<AddDrinks> {
  bool isDone = false;
  List<Drink> drinks = [];
